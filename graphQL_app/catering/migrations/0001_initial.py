# Generated by Django 4.1.3 on 2023-01-21 20:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dane_klienta', models.ManyToManyField(to='catering.klient')),
                ('posilki', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catering.posilki')),
            ],
        ),
    ]
